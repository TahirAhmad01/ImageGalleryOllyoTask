...
function ImageCard({ id, index, imageSrc, selected, onClick, moveCard }) {
  ...
  return (
    <div
      className={`border-2 rounded-lg bg-gray-300 overflow-hidden relative block before:contents[""] before:absolute before:h-0 before:w-0 before:bg-black before:opacity-0 before:transition before:ease-in-out before:duration-[.6s] hover:before:opacity-40 hover:before:h-full hover:before:w-full hover:cursor-pointer group ${
        isDrop &&
